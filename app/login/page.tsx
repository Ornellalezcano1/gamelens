...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Convertimos err a un tipo que contenga 'code' para evitar el error de lint sin cambiar la lógica
  ...
  return (
    <div className="min-h-screen w-full bg-[#0a0a0a] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* 1. Fondo Mesh Gradient (Efecto Aurora/Gamer) */}
      <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
        {/* Círculo Violeta Superior Izquierdo */}
      ...
      {/* 2. Contenedor Principal (Tarjeta Glassmorphism) */}
      <div className="w-full max-w-md bg-neutral-900/60 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8 relative z-10 flex flex-col gap-6">
        ...
        <div className="flex flex-col items-center justify-center space-y-4 mb-2">
          {/* Contenedor del Logo con rotación en hover */}
          <div className="relative w-24 h-24 transition-transform duration-700 ease-in-out hover:rotate-[360deg] cursor-pointer">
            {/* Fondo brillante detrás del logo */}
